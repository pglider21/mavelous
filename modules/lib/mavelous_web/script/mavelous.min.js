...
f[h],b.type,!0,b)&&0!=b.returnValue_}if(!1 in d)if(g=d[!1],g.remaining_=g.count_,c)for(h=0;!b.propagationStopped_&&h<f.length&&g.remaining_;h++)b.currentTarget=f[h],e&=goog.events.fireListeners_(g,f[h],b.type,!1,b)&&0!=b.returnValue_;else for(d=a;!b.propagationStopped_&&d&&g.remaining_;d=d.getParentEventTarget())b.currentTarget=d,e&=goog.events.fireListeners_(g,d,b.type,!1,b)&&0!=b.returnValue_;return Boolean(e)};
...
goog.exportProperty(Mavelous.CommStatusModel.prototype,"defaults",Mavelous.CommStatusModel.prototype.defaults);Mavelous.CommStatusModel.prototype.initialize=function(){var a=this.get("mavlinkSrc");a.subscribe("HEARTBEAT",this.onHeartbeat,this);a.on("gotServerResponse",this.onServerSuccess,this);a.on("gotServerError",this.onServerError,this);this.resetServerTimeout()};goog.exportProperty(Mavelous.CommStatusModel.prototype,"initialize",Mavelous.CommStatusModel.prototype.initialize);
...
Mavelous.PacketLossModel.prototype.defaults=function(){return{history:[],current:-1}};goog.exportProperty(Mavelous.PacketLossModel.prototype,"defaults",Mavelous.PacketLossModel.prototype.defaults);Mavelous.PacketLossModel.prototype.initialize=function(){this.metalinkquality=this.get("mavlinkSrc").subscribe("META_LINKQUALITY",this.onMessage,this)};goog.exportProperty(Mavelous.PacketLossModel.prototype,"initialize",Mavelous.PacketLossModel.prototype.initialize);
...
goog.exportProperty(Mavelous.CommStatusButtonView.prototype,"initialize",Mavelous.CommStatusButtonView.prototype.initialize);
...
b="Link: Error");this.$el.addClass(c);b='<span class="hidden-phone">'+b+'</span><i class="icon-signal icon-white visible-phone"></i>';this.$el.html(b)};Mavelous.AirspeedButton=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.AirspeedButton,Backbone.View);Mavelous.AirspeedButton.prototype.initialize=function(){this.controlstates=this.options.mavlinkSrc.subscribe("CONTROL_SYSTEM_STATE",this.onSysStatus,this);this.$el=this.options.el};goog.exportProperty(Mavelous.AirspeedButton.prototype,"initialize",Mavelous.AirspeedButton.prototype.initialize);
Mavelous.AirspeedButton.prototype.onSysStatus=function(){var a=this.controlstates.get("airspeed");-1==a?this.setButton_("btn-inverse","Unknown"):this.setButton_("btn-success",a+"m/s")};Mavelous.AirspeedButton.prototype.setButton_=function(a,b){this.$el.removeClass("btn-success btn-inverse");this.$el.addClass(a);var c;c='<span class="hidden-phone">AirSpd: '+b+'</span><i class="icon-fire icon-white visible-phone"></i>';this.$el.html(c)};goog.dom={};goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);a.className=c.join(" ");return c.length==e};
...
goog.net.jsloader.Error=function(a,b){var c="Jsloader error (code #"+a+")";b&&(c+=": "+b);goog.debug.Error.call(this,c);this.code=a};goog.inherits(goog.net.jsloader.Error,goog.debug.Error);Mavelous.LeafletDroneIconModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.LeafletDroneIconModel,Backbone.Model);Mavelous.LeafletDroneIconModel.prototype.defaults=function(){return{icon:"predatorsmall"}};goog.exportProperty(Mavelous.LeafletDroneIconModel.prototype,"defaults",Mavelous.LeafletDroneIconModel.prototype.defaults);Mavelous.LeafletDroneIconModel.prototype.getIcon=function(){var a=this.get("icon");return new Mavelous.LeafletDroneIconModel.Icons[a].constructor};
...
Mavelous.FlightModePopoverViewDelegate.prototype.setupPopover=function(){this.$el.find(".popover-content").html('<p><a class="btn" id="flightmode-btn-arm" href="#">Arm</a></p><br /><a class="btn" id="flightmode-btn-loiter" href="#">Loiter</a><a class="btn" id="flightmode-btn-rtl" href="#">RTL</a><a class="btn" id="flightmode-btn-land" href="#">Land</a><a class="btn" id="flightmode-btn-auto" href="#">Auto</a>');this.armingButtonView=new Mavelous.ArmingButtonView({el:$("#flightmode-btn-arm"),model:this.modeModel});
this.loiterButtonView=new Mavelous.CommandButtonView({el:$("#flightmode-btn-loiter"),model:this.commandModel,command:"NAV_LOITER_UNLIM"});this.rtlButtonView=new Mavelous.CommandButtonView({el:$("#flightmode-btn-rtl"),model:this.commandModel,command:"NAV_RETURN_TO_LAUNCH"});this.landButtonView=new Mavelous.CommandButtonView({el:$("#flightmode-btn-land"),model:this.commandModel,command:"NAV_LAND"});this.autoButtonView=new Mavelous.CommandButtonView({el:$("#flightmode-btn-auto"),model:this.commandModel,
command:"NAV_AUTO"})};Mavelous.FlightModePopoverViewDelegate.prototype.cleanupSubview=function(a){this[a]&&(this[a].remove(),this[a]=null)};Mavelous.AppRouter=function(a){this.pfdSettingsModel=a.pfdSettingsModel;this.routes={overview:"route_overview",fullpfd:"route_fullpfd",maponly:"route_maponly"};Backbone.Router.call(this,a)};goog.inherits(Mavelous.AppRouter,Backbone.Router);Mavelous.AppRouter.prototype.initialize=function(a){var b={};_.each(this.routes,function(a,d){var e=$("#navbar-"+d);0<e.length&&(b[d]=e)});this.navbar=b};goog.exportProperty(Mavelous.AppRouter.prototype,"initialize",Mavelous.AppRouter.prototype.initialize);
Mavelous.AppRouter.prototype.route_overview=function(){this.setnavbar("overview");this.pfdSettingsModel.set({size:Mavelous.PFDSettingsModel.Size.STANDARD})};goog.exportProperty(Mavelous.AppRouter.prototype,"route_overview",Mavelous.AppRouter.prototype.route_overview);Mavelous.AppRouter.prototype.route_fullpfd=function(){this.setnavbar("fullpfd");this.pfdSettingsModel.set({size:Mavelous.PFDSettingsModel.Size.FULLSCREEN})};goog.exportProperty(Mavelous.AppRouter.prototype,"route_fullpfd",Mavelous.AppRouter.prototype.route_fullpfd);
Mavelous.AppRouter.prototype.route_maponly=function(){this.setnavbar("maponly");this.pfdSettingsModel.set({size:Mavelous.PFDSettingsModel.Size.HIDDEN})};goog.exportProperty(Mavelous.AppRouter.prototype,"route_maponly",Mavelous.AppRouter.prototype.route_maponly);Mavelous.AppRouter.prototype.setnavbar=function(a){_.each(this.navbar,function(a){a.removeClass("active")});this.navbar[a].addClass("active")};Mavelous.ArtificialHorizon=function(a){this.initArtificialHorizon_(a);Kinetic.Shape.call(this,a)};goog.inherits(Mavelous.ArtificialHorizon,Kinetic.Shape);Mavelous.ArtificialHorizon.prototype.initArtificialHorizon_=function(a){Kinetic.Shape.call(this,a);this.setAttrs({width:100,height:100,skyColor:"#72cde4",groundColor:"#323232",lineColor:"#ffffff",planeColor:"black"});this.shapeType="ArtificialHorizon";this.radius=Math.min(a.width,a.height)/2;this.roll=this.pitch=0;this._setDrawFuncs()};
...
30,.3*d);this.drawPitchRung_(a,25,.05*d);this.drawPitchRung_(a,20,.2*d);this.drawPitchRung_(a,15,.05*d);this.drawPitchRung_(a,10,.1*d);this.drawPitchRung_(a,5,.05*d);b=.9*this.radius;a.beginPath();a.arc(0,0,b,210*Math.PI/180,330*Math.PI/180,!1);a.stroke();this.drawRollRung_(a,210*Math.PI/180,10,b);this.drawRollRung_(a,220*Math.PI/180,5,b);this.drawRollRung_(a,230*Math.PI/180,10,b);this.drawRollRung_(a,240*Math.PI/180,5,b);this.drawRollRung_(a,250*Math.PI/180,5,b);this.drawRollRung_(a,260*Math.PI/
...
this),this.onSettingsChange());this.onAttitudeChange();this.onVfrHudChange();this.onNavControllerOutputChange()};goog.exportProperty(Mavelous.PFDView.prototype,"initialize",Mavelous.PFDView.prototype.initialize);Mavelous.PFDView.prototype.onAttitudeChange=function(){this.pfd.setAttitude(this.attitude.get("pitch"),this.attitude.get("roll"));this.pfd.draw()};
...
goog.exportProperty(Mavelous.GuideAltitudeView.prototype,"initialize",Mavelous.GuideAltitudeView.prototype.initialize);Mavelous.GuideAltitudeView.prototype.render=function(){var a=this.model.toJSON();this.text.html(a.alt.toString()+" m");this.input.val(a.alt);return this};goog.exportProperty(Mavelous.GuideAltitudeView.prototype,"render",Mavelous.GuideAltitudeView.prototype.render);Mavelous.FakeVehicle=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.FakeVehicle,Backbone.Model);Mavelous.FakeVehicle.prototype.defaults=function(){return{lat:37.7751,lon:-122.419,alt:30,heading:90,pitch:0,roll:0,velocity:10,t:0}};Mavelous.FakeVehicle.prototype.initialize=function(){var a=Date.now();this.lastmessagetime=this.lastupdate=this.firstupdate=a};goog.exportProperty(Mavelous.FakeVehicle.prototype,"initialize",Mavelous.FakeVehicle.prototype.initialize);
...
goog.exportProperty(Mavelous.MavlinkAPI.prototype,"initialize",Mavelous.MavlinkAPI.prototype.initialize);Mavelous.MavlinkAPI.prototype.subscribe=function(a,b,c){this.messageModels[a]||(this.messageModels[a]=new Mavelous.MavlinkMessage({_type:a,_index:-1}));a=this.messageModels[a];a.bind("change",b,c);return a};Mavelous.MavlinkAPI.prototype.handleMessages_=function(a){this.trigger("gotServerResponse");_.each(a,this.handleMessage_,this)};
...
Mavelous.MavlinkAPI.prototype.offlineUpdate=function(){goog.asserts.assert(this.fakevehicle);this.fakevehicle.update();var a=this.fakevehicle.requestMessages(this.messageModels);this.handleMessages_(a)};Mavelous.MavlinkAPI.prototype.useOfflineMode=function(){this.online&&!this.gotonline&&(this.logger_.info("Switching to offline mode"),this.online=!1,this.fakevehicle=new Mavelous.FakeVehicle({lat:45.5233,lon:-122.667}))};Mavelous.FlightModeModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.FlightModeModel,Backbone.Model);Mavelous.FlightModeModel.prototype.defaults=function(){return{armed:!1,arming:!1,disarming:!1,modestring:"None"}};goog.exportProperty(Mavelous.FlightModeModel.prototype,"defaults",Mavelous.FlightModeModel.prototype.defaults);
Mavelous.FlightModeModel.prototype.initialize=function(){this.heartbeat=this.get("mavlinkSrc").subscribe("HEARTBEAT",this.onHeartbeat,this);this.on("change:armed",this.onChangeArmed,this)};goog.exportProperty(Mavelous.FlightModeModel.prototype,"initialize",Mavelous.FlightModeModel.prototype.initialize);Mavelous.FlightModeModel.prototype.onHeartbeat=function(){var a=Mavelous.util.heartbeat.modestring(this.heartbeat),b=Mavelous.util.heartbeat.armed(this.heartbeat);this.set({armed:b,modestring:a})};
...
Mavelous.CommandButtonView.prototype.initialize=function(){this.command=this.options.command;this.$el.click(goog.bind(this.onClick_,this))};goog.exportProperty(Mavelous.CommandButtonView.prototype,"initialize",Mavelous.CommandButtonView.prototype.initialize);Mavelous.CommandButtonView.prototype.onClick_=function(){this.model.post(this.command)};Mavelous.FlightModeButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.FlightModeButtonView,Backbone.View);
Mavelous.FlightModeButtonView.prototype.initialize=function(){this.modeModel=this.options.modeModel;this.$el=this.options.el;this.modeModel.on("change",this.onChange_,this)};goog.exportProperty(Mavelous.FlightModeButtonView.prototype,"initialize",Mavelous.FlightModeButtonView.prototype.initialize);
Mavelous.FlightModeButtonView.prototype.onChange_=function(){this.$el.removeClass("btn-success btn-warning");this.modeModel.get("armed")?this.$el.addClass("btn-success"):this.$el.addClass("btn-warning");this.$el.html(this.modeModel.get("modestring"))};Mavelous.SettingsView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.SettingsView,Backbone.View);
...
goog.exportProperty(Mavelous.SettingsView.prototype,"initialize",Mavelous.SettingsView.prototype.initialize);Mavelous.SettingsView.prototype.setupMapProviderPicker=function(){var a=this;void 0!==this.mapProviderModel&&(_.each(Mavelous.LeafletProviders.Providers,function(b,c){a.mapProviderPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.mapProviderPicker.change(function(){var b=a.mapProviderPicker.val();a.mapProviderModel.set("provider",b)}))};
...
this);this.vehicleModel.bind("change",this.updateVehiclePath,this);this.map.addEventListener("dblclick",this.doubleClickHandler,this);this.guideModel.bind("change",this.updateGuideMarker,this)};goog.exportProperty(Mavelous.LeafletView.prototype,"initialize",Mavelous.LeafletView.prototype.initialize);Mavelous.LeafletView.prototype.doubleClickHandler=function(a){this.guideModel.setTarget({lat:a.latlng.lat,lon:a.latlng.lng})};
...
Mavelous.LeafletView.prototype.updateVehiclePath=function(){var a=this.vehicleModel.get("position");a&&0!=this.vehiclePathVisible&&(void 0===this.vehiclePath?(this.vehiclePath=new L.Polyline([a],{color:"red"}),this.vehiclePath.addTo(this.map)):this.vehiclePath.addLatLng(a))};
Mavelous.LeafletView.prototype.updateGuideMarker=function(){var a=this.guideModel.toJSON(),b=new L.LatLng(a.lat,a.lon);a&&(void 0===this.guideMarker?(this.guideMarker=new L.Marker(b,{icon:new markerIcon}),this.map.addLayer(this.guideMarker)):this.guideMarker.setLatLng(b))};Mavelous.VehicleLeafletPosition=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.VehicleLeafletPosition,Backbone.Model);Mavelous.VehicleLeafletPosition.prototype.defaults=function(){return{position:null,heading:0}};goog.exportProperty(Mavelous.VehicleLeafletPosition.prototype,"defaults",Mavelous.VehicleLeafletPosition.prototype.defaults);
Mavelous.VehicleLeafletPosition.prototype.initialize=function(){var a=this.get("mavlinkSrc");this.vehicleGps=a.subscribe("GPS_RAW_INT",this.withVehicleGps,this);this.vehicleHead=a.subscribe("VFR_HUD",this.withVehicleHead,this)};goog.exportProperty(Mavelous.VehicleLeafletPosition.prototype,"initialize",Mavelous.VehicleLeafletPosition.prototype.initialize);
Mavelous.VehicleLeafletPosition.prototype.withVehicleGps=function(){var a=this.vehicleGps.toJSON();0===a.lat&&0===a.lon||this.set("position",new L.LatLng(a.lat/1E7,a.lon/1E7))};Mavelous.VehicleLeafletPosition.prototype.withVehicleHead=function(){var a=this.vehicleHead.get("heading");this.set("heading",a)};Mavelous.GuideModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.GuideModel,Backbone.Model);Mavelous.GuideModel.prototype.defaults=function(){return{alt:20,lat:null,lon:null}};goog.exportProperty(Mavelous.GuideModel.prototype,"defaults",Mavelous.GuideModel.prototype.defaults);Mavelous.GuideModel.prototype.initialize=function(){this.metaWaypointModel=this.get("mavlinkSrc").subscribe("META_WAYPOINT",this.onMetaWaypointChange,this)};
goog.exportProperty(Mavelous.GuideModel.prototype,"initialize",Mavelous.GuideModel.prototype.initialize);Mavelous.GuideModel.prototype.onMetaWaypointChange=function(){var a=this.metaWaypointModel.get("waypoint");a&&this.set({alt:a.alt,lat:a.lat,lon:a.lon})};Mavelous.GuideModel.prototype.setTarget=function(a){this.set(a);this.send()};Mavelous.GuideModel.prototype.send=function(){var a={lat:this.get("lat"),lon:this.get("lon"),alt:this.get("alt")};null!==a.lat&&null!==a.lon&&null!==a.alt&&this.sendServer(a)};
Mavelous.GuideModel.prototype.sendServer=function(a){a=goog.json.serialize({command:"FLYTO",location:a});$.ajax({type:"POST",url:"/guide",data:a})};Mavelous.LeafletProviders=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.LeafletProviders,Backbone.Model);Mavelous.LeafletProviders.bingKey="AnFxXUB376BgaEQMj947c43V45ipmMvdcoY-TAE4-Y23mu1yFLHF0k2BMJP-MU1B";Mavelous.LeafletProviders.prototype.defaults=function(){return{provider:"bing"}};goog.exportProperty(Mavelous.LeafletProviders.prototype,"defaults",Mavelous.LeafletProviders.prototype.defaults);
...
this.batteryButton=new Mavelous.BatteryButton({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-battery")});this.airspeedButton=new Mavelous.AirspeedButton({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-airspeed")});this.settingsView=new Mavelous.SettingsView({map:this.mapView.map,mapView:this.mapView,mapProviderModel:this.leafletProviders,vehicleIconModel:this.leafletDroneIcon,modalToggle:$("#navbar-a-settings"),modal:$("#settings-modal"),mapProviderPicker:$("#settings-mapproviderpicker"),mapZoomSlider:$("#settings-mapzoom"),
mapZoomValue:$("#settings-mapzoom-value"),mapPathPicker:$("#settings-mappathpicker"),vehicleIconPicker:$("#settings-vehicleiconpicker"),pfdSettingsModel:this.pfdSettingsModel,pfdPositionLeft:$("#settings-pfdpos-left"),pfdPositionRight:$("#settings-pfdpos-right"),pfdPositionUp:$("#settings-pfdpos-up"),pfdPositionDown:$("#settings-pfdpos-down")});this.router=new Mavelous.AppRouter({pfdSettingsModel:this.pfdSettingsModel});Backbone.history.start();767<$(window).width()?this.router.navigate("overview",
